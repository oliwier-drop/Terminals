# GNU General Public License v3 — fork-authored code
...
When you distribute combined works that include both GPL-3.0 fork code and MS-CL upstream code, you must comply with **both** applicable licenses and provide corresponding source for GPL-covered components. See [README.md](README.md#license-mixed).
